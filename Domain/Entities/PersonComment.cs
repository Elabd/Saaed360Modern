...
public partial class PersonComment
{
    ...
    public virtual ICollection<Subject> SubjectStatements { get; set; } = new List<Subject>();

    public virtual ICollection<Subject> SubjectSubjectNotices { get; set; } = new List<Subject>();

    public virtual ICollection<Subject> SubjectSubjectSpecialHandlings { get; set; } = new List<Subject>();
}
