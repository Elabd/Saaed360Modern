...
public partial class SaaedReportTotalIncidentDetail
{
    ...
    public decimal? SavingResponseTime { get; set; }

    public decimal? DispatchResponseTime { get; set; }

    public decimal? Arrival1ResponseTime { get; set; }

    public decimal? Arrival2ResponseTime { get; set; }

    public decimal? ReconstructionTime { get; set; }

    public decimal? AverageResponseTime { get; set; }

    public decimal? TotalResponseTime { get; set; }

    public decimal? AverageAssignTime { get; set; }

    public decimal? AverageClosedTime { get; set; }
